...
indexi = Artist.create!(
  ...
  remote_image_url: 'http://res.cloudinary.com/dic1tttru/image/upload/v1510422551/indexi-putovi-diskoton_n365p5.jpg'
)
...
time = Artist.create!(
  ...
  remote_image_url: 'http://res.cloudinary.com/dic1tttru/image/upload/v1510422551/FRONT_lc5b6n.jpg'
)
